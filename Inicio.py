...
with col1:
    st.image("assets/jhon.jpg", width=200, caption="Estudiante", output_format="JPEG")
...
with col2:
    ...
    st.markdown('<p style="margin-top: 10px;">integrantes: <span style="color: #0066cc; font-weight: bold;">jhon jairo devia velasco</span></p>', unsafe_allow_html=True)
